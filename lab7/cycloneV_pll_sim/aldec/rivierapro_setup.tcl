...
# ACDS 20.1 711 win32 2024.02.27.10:10:56
# ----------------------------------------
...
# ----------------------------------------
# If cycloneV_pll is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "cycloneV_pll"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/cycloneV_pll.vho"
}
