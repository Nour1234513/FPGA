...
# ----------------------------------------
# If pll_cycloneV is one of several IP cores in your
...
# ----------------------------------------
# ACDS 20.1 711 win32 2024.02.27.05:30:51
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "pll_cycloneV"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_cycloneV.vho"
}
